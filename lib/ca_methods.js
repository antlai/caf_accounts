...
exports.methods = {
    ...
    async getSiteKey() {
        return [null, this.$.recaptcha.getSiteKey()];
    },
    async hello(user) {
    ...
    async newAccount(account, reCaptcha) {
        try {
            /*
             It blocks this CA for about 120ms. Need to use different
             CAs based on, e.g., first two characters of acc name.
             */
            accUtils.checkUsername(this, account.username);
